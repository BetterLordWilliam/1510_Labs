...
public class NameDriver {
    ...
    public static void main(String[] args) {
        ...
        // Test the new setters
        willOtterbein.setFirstName("alex");
        System.out.println(willOtterbein.getFirstName() + ", name remains unchanged.");
        ...
        System.out.println("String at n: " + willOtterbein.getCharAt(oneThousand));
